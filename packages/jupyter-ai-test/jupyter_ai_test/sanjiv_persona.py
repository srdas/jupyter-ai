...
class SanjivPersona(BasePersona):
    """
    ...
    async def process_message(self, message: Message):
        ...
        if "/export" in variables.input:
            ...
            print(f"Exported file {chatfile} in markdown format to {mdfile}.")
            self.send_message(f"Exported file {chatfile} in markdown format to {mdfile}.")
